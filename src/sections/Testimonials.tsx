  ...
  return (
    <section className="py-20 md:py-24">
      <div className="container text-white">
        <h2 className="text-white md:text-6xl text-2xl text-center font-medium tracking-tighter">
          Beyond Expectations
        </h2>
          ...
          >
            {[...testimonials, ...testimonials].map((testimonial) => (
              <div
                ...
                /*flex-none ensures that flexbox remains no responsible for height & width */
                className="border flex-none max-w-xs md:max-w-md p-5 md:p-10  border-white/15  rounded-xl bg-[linear-gradient(to_bottom_left,rgb(149,69,255,.3),black)]"
              >
                <div className="tracking-tight text-lg md:text-2xl">
                  {testimonial.text}
                </div>
                <div className="flex items-center gap-3 mt-5">
                  <div className="relative after:content-[''] after:absolute after:inset-0 after:bg-[rgb(140,69,244)] after:mix-blend-soft-light before:content-[''] before:absolute before:inset-0 before:border before:border-white/30  before:rounded-lg /* overlaying */">
                    <Image
                      ...
                      className="grayscale rounded-lg h-11 w-11 border border-white/50"
                    />
                  </div>
                  <div>
